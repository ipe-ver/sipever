      ...
      <div class="box box-solid">
        <div class="box-body">
          <div class="nav-tabs-custom">
            <h4 style="text-align:right"><strong>OFICINA DE INFRAESTRUCTURA Y ASISTENCIA TÉCNICA</strong></h4>
            <br>

            <div class="callout callout" style="background: #FFBE40;">
                <h4>Objetivo:</h4>

                <p style="font-size: 20px;">Garantizar el adecuado funcionamiento de las tecnologías de información y comunicación (software y hardware) en los diferentes departamentos de la
                Institución, mediante la realización de mantenimientos de preventivos y correctivos.</p>
            </div> <!-- ./ callout -->
