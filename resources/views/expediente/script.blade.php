<style type="text/css">
	...
	***********************************************************************************************/
		...
		campos1 = estilo_modal.mostrar([
				{campo:'select', idCampo:'actpen', nameCampo:'Activo o Pensionado:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.actpen: '', placeholder:'', newClass:'', divSize:'4', datos: catActPen},

				{campo:'input', idCampo:'numero', nameCampo:'Número de Afiliación o Pensionado:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.numero: '', placeholder:'Número de Afiliación o Pensionado', newClass:'mayuscula', divSize:'4', datos:''},

				{campo:'input', idCampo:'fecha_ingreso', nameCampo:'Fecha de Ingreso:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.fecha_ingreso: '', placeholder:'Fecha de Ingreso', newClass:'mayuscula', divSize:'4', datos:''},
					
		]);	

		campos2 = estilo_modal.mostrar([
				{campo:'input', idCampo:'paterno', nameCampo:'Apellido Paterno:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.paterno: '', placeholder:'Apellido Paterno',newClass:'mayuscula', divSize:'4', datos:''},

				{campo:'input', idCampo:'materno', nameCampo:'Apellido Materno:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.materno: '', placeholder:'Apellido Materno',newClass:'mayuscula', divSize:'4', datos:''},

				{campo:'input', idCampo:'nombre', nameCampo:'Nombres:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.nombre: '', placeholder:'Nombres', newClass:'mayuscula',divSize:'4', datos:''},
					
		]);	

		campos3 = estilo_modal.mostrar([
				{campo:'input', idCampo:'fecha_nacimiento', nameCampo:'Fecha de Nacimiento:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.fecha_nacimiento: '', placeholder:'Fecha de Nacimiento', newClass:'mayuscula', divSize:'4', datos: ''},

				{campo:'select', idCampo:'sexo', nameCampo:'Sexo:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.sexo: '', placeholder:'', newClass:'', divSize:'4', datos: catSexo},

				{campo:'select', idCampo:'id_estadocivil', nameCampo:'Edo. Civil:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.id_estadocivil: '', placeholder:'', newClass:'', divSize:'4', datos: catEdoCivil},	
					
		]);	

				
		campos4 = estilo_modal.mostrar([
				{campo:'input', idCampo:'rfc', nameCampo:'RFC:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.rfc: '', placeholder:'RFC', newClass:'mayuscula', divSize:'4', datos:''},

				{campo:'input', idCampo:'curp', nameCampo:'CURP:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.curp: '', placeholder:'CURP', newClass:'mayuscula', divSize:'4', datos:''},

				{campo:'input', idCampo:'nss', nameCampo:'Número de Seguridad Social:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.nss: '', placeholder:'Número de Seguridad Social', newClass:'mayuscula', divSize:'4', datos: ''},			
		]);	

		campos5 = estilo_modal.mostrar([
				{campo:'input', idCampo:'ine', nameCampo:'Folio del INE:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.ine: '', placeholder:'Folio del INE', newClass:'mayuscula', divSize:'4', datos: ''},

				{campo:'input', idCampo:'correo_electronico_personal', nameCampo:'Correo Eléctronico:', typeCampo:'text', valorCampo: (Object.keys(actpen).length)? actpen.correo_electronico_personal: '', placeholder:'Correo Eléctronico', newClass:'mayuscula', divSize:'4', datos: ''},	
		...
		$('#datos_personales').append(campos1);
		$('#datos_personales').append(campos2);
		$('#datos_personales').append(campos3);
		$('#datos_personales').append(campos4);
		$('#datos_personales').append(campos5);
		$('#datos_personales').append(campos6);

		$('#datos_domicilio').append(campos7);
		$('#datos_domicilio').append(campos8);
		$('#datos_domicilio').append(campos9);

		$('#datos_profesionales').append(campos10);
